...
<body>
  ...
  <div class="container-fluid mt-3 mb-3" id="centro">
    <div class="row d-inline-flex my-5">
        <a class="btn btn-primary" href="PrincipalCadastrarUsuario.php" role="button">CADASTRO DE USUÁRIOS</a>
    </div>

    <div class="row d-inline-flex my-5">
        <a class="btn btn-primary" href="RelatorioUsuario.php" role="button">RELATÓRIOS</a>
    </div>
  </div>
