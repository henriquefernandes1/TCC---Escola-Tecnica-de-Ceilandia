...
<head>
  ...
  <title>BEM-VINDO, SERVIDOR(A)</title>
</head>
...
<body>
  ...
  <div class="container-fluid mt-3 mb-3" id="centro">
    <div class="row d-inline-flex my-5">
        <a class="btn btn-primary" href="PrincipalCadastrarMap.php" role="button">MAPEAMENTO</a>
    </div>
      
      <div class="row d-inline-flex my-5">
          <a class="btn btn-primary" href="PrincipalCadastrarChec.php" role="button">CHECAGEM</a>
    </div>
