...
// Título do Relatório mapeamento
$pdf->SetFont('Arial', 'B', 20);

$pdf->Cell(190, 20, utf8_decode('Relatório de Atividade Semanal-Mapeamento'), 0, 0, "L");
$pdf->Ln(15);

//Início da construção da tabela mapeamento
...
// Título do Relatório
$pdf->SetFont('Arial', 'B', 20);
$pdf->Cell(190, 20, utf8_decode('Relatório de Atividade Semanal-Checagem'), 0, 0, "L");
$pdf->Ln(15);

//Início da construção da tabela Chegagem
$pdf->SetFont("Arial", "I", 10);
$pdf->Cell(40, 7, "Desordem", 1, 0, "C");
$pdf->Cell(48, 7, "Endereco", 1, 0, "C");
$pdf->Cell(35, 7, "Orgao Responsavel", 1, 0, "C");
...
foreach ($consulta as $c) {
    ...
    $pdf->Cell(48, 7, utf8_decode($c["Endereco"]), 1, 0, "C");
    $pdf->Cell(35, 7, utf8_decode($c["Org_Responsavel"]), 1, 0, "C");
    $pdf->Cell(12, 7, utf8_decode($c["idChecagem"]), 1, 0, "C");
    $pdf->Cell(12, 7, $c["Ponto"], 1, 0, "C");
    $pdf->Cell(40, 7, formatoData($c["Data"]), 1, 0, "C");
    $pdf->Cell(40, 7, utf8_decode($c["Status"]), 1, 0, "C");
    $pdf->Cell(25, 7, utf8_decode($c["Nome"]), 1, 0, "C");
    $pdf->Cell(15, 7, $pdf->Image($imagem, $pdf->GetX(), $pdf->GetY(), 12.20), 1, 1, 'C');
    $pdf->Ln();
}
